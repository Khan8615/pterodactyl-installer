...
# download URLs
WINGS_DL_BASE_URL="https://github.com/pterodactyl/wings/releases/download/v1.7.4/wings_linux_amd64"
GITHUB_BASE_URL="https://raw.githubusercontent.com/Khan8615/pterodactyl-installer/$GITHUB_SOURCE"
