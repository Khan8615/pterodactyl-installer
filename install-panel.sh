...
# download URLs
PANEL_DL_URL="https://github.com/pterodactyl/panel/releases/download/v1.8.1/panel.tar.gz" #"https://github.com/pterodactyl/panel/releases/latest/download/panel.tar.gz"
